...
def load_ECOv002_calval_JET_outputs() -> pd.DataFrame:
    """
    ...
    load_file_path = os.path.join(module_dir, "ECOv002-cal-val-JET-outputs.csv")

    # Load the output data into a DataFrame
    outputs_df = pd.read_csv(load_file_path)
